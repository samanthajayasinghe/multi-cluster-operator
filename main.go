...
import (
	...
	"github.com/samanthajayasinghe/multi-cluster-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(conf, ctrl.Options{
		...
		LeaderElectionID:       "f2c55662.samanthajayasinghe.github.io",
	...
	_, err = controllers.NewLogForwarderReconciler(mgr, clusters)
	checkErr(err, "NewLogForwarderReconciler")

	if err = (&controllers.LogForwarderReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LogForwarder")
		os.Exit(1)
	}
